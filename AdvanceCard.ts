...
export class AdvanceCard {
    ...
    public updatePrefixLabelTransform() {
        ...
        this.prefixLabelGroupElement.attr("transform", translate(x, y + dataLabelSize.height + 10));
    }
    ...
    public updatePostfixLabelTransform() {
        ...
        this.postfixLabelGroupElement.attr("transform", translate(x, y + dataLabelSize.height + 10 + prefixLabelSize.height + 10));
    }
    ...
    private getYForTopRow() {
        ...
        if (this.settings.categoryLabelSettings.show) {
            y = (0 - dataLabelSize.y) + (this.rootSVGSize.height - dataLabelSize.height) / 3 - categoryLabelSize.height / 3;
        } else {
            y = (0 - dataLabelSize.y) + (this.rootSVGSize.height - dataLabelSize.height) / 3;
        }
        return y;
    }
